...
urlpatterns = [
    ...
    path('test-flask/', views.fetch_donations_from_flask, name='test-flask'),
    path('flask-login/', views.flask_login_view, name='flask-login'),
        # path('flask-dashboard/<str:username>/', views.flask_dashboard_view, name='flask_dashboard'),
